...
REM #    - WLANPi with image v1.8.4 or later*
REM #    - 2 x wireless NIC capable of monitor mode plugged in to the WLANPi 
REM #      (only 2 x CF-912 tested to date...AC1750 failed, presume USB power issues)
REM #    - Network connectivity between the Wireshark laptop & WLANPi
REM #
REM # (* To make this work on v1.8.4, SSH to your WLANPi and edit the file:
REM #
...
REM #  to:
REM #
REM #    wlanpi ALL = (root) NOPASSWD: /sbin/ip, /usr/sbin/iw, /bin/date, /usr/bin/tshark
REM #
REM #  ...and then save)
REM #
REM #  Also, configure wlan1 as follows in /etc/network/interfaces (edit with nano):
REM # 
REM #    allow-hotplug wlan1
REM #    iface wlan1 inet dhcp
REM #    #   wpa-conf /etc/wpa_supplicant/wpa_supplicant.conf
REM #    # Disable power saving on compatible chipsets (prevents SSH/connection dropouts$
REM #    wireless-mode Monitor
REM #    #wireless-mode Managed
REM # 
REM #  Finally, ensure tshark is installed:
REM # 
REM #    # apt-get update
REM #    # apt-get nstall tshark
REM #
REM #   *** Important: due to frame sequence number issues due ot the collection method
REM #   *** any resulting capture file must be either sorted by the Wireshark time column
REM #   *** or run through the 'reordercap' utility that comes with Wireshark
REM #   *** e.g. reordrercap.exe raw_capture.pcap ordered_capture.pcap
REM #
REM # Installation:
REM #
...
:init
	...
	set "remote_filter="
    set "remote_channel2=11"
	set "remote_channel_width2=HT20"
...
:parse
    ...
    if /i "%~1"=="--remote-interface2"      set "remote_interface2=%~2" & shift & shift & goto :parse
	if /i "%~1"=="--remote-channel2"        set "remote_channel2=%~2" & shift & shift & goto :parse
	if /i "%~1"=="--remote-channel-width2"  set "remote_channel_width2=%~2" & shift & shift & goto :parse
	if /i "%~1"=="--frame-slice2"           set "frame_slice2=%~2" & shift & shift & goto :parse
...
:extcap_interface_func
    ...
    echo interface {value=wifidump2}{display=WLAN Pi dual rem capture (Win) (v%__VERSION%)}
	EXIT /B 0
...
:extcap_config_func
    ...
    echo arg {number=11}{call=--remote-channel2}{display=Channel2}{type=selector}{tooltip=The channel to capture (1-14, 36-165)}{group=Capture}
    echo arg {number=12}{call=--remote-channel-width2}{display=Channel Width2}{type=selector}{tooltip=The width of the channel to capture}{group=Capture}
	...
	echo arg {number=13}{call=--remote-interface2}{display=Remote Interface}{type=string}{tooltip=The name of the interface used for capturing (usually wlan1 in the WLANPi)}{default=wlan1}{group=Advanced}
    ...
    rem # Channel values
    echo value {arg=11}{value=1}{display=Channel 1}
	echo value {arg=11}{value=2}{display=Channel 2}
	echo value {arg=11}{value=3}{display=Channel 3}
	echo value {arg=11}{value=4}{display=Channel 4}
	echo value {arg=11}{value=5}{display=Channel 5}
	echo value {arg=11}{value=6}{display=Channel 6}
	echo value {arg=11}{value=7}{display=Channel 7}
	echo value {arg=11}{value=8}{display=Channel 8}
	echo value {arg=11}{value=9}{display=Channel 9}
	echo value {arg=11}{value=10}{display=Channel 10}
	echo value {arg=11}{value=11}{display=Channel 11}
	echo value {arg=11}{value=12}{display=Channel 12}
	echo value {arg=11}{value=13}{display=Channel 13}
	echo value {arg=11}{value=13}{display=Channel 14}
	echo value {arg=11}{value=36}{display=Channel 36}
	echo value {arg=11}{value=40}{display=Channel 40}
	echo value {arg=11}{value=44}{display=Channel 44}
	echo value {arg=11}{value=48}{display=Channel 48}
	echo value {arg=11}{value=52}{display=Channel 52}
	echo value {arg=11}{value=56}{display=Channel 56}
	echo value {arg=11}{value=60}{display=Channel 60}
	echo value {arg=11}{value=64}{display=Channel 64}
	echo value {arg=11}{value=100}{display=Channel 100}
	echo value {arg=11}{value=104}{display=Channel 104}
	echo value {arg=11}{value=108}{display=Channel 108}
	echo value {arg=11}{value=112}{display=Channel 112}
	echo value {arg=11}{value=116}{display=Channel 116}
	echo value {arg=11}{value=120}{display=Channel 120}
	echo value {arg=11}{value=124}{display=Channel 124}
	echo value {arg=11}{value=128}{display=Channel 128}
	echo value {arg=11}{value=132}{display=Channel 132}
	echo value {arg=11}{value=136}{display=Channel 136}
	echo value {arg=11}{value=140}{display=Channel 140}
	echo value {arg=11}{value=144}{display=Channel 144}
	echo value {arg=11}{value=149}{display=Channel 149}
	echo value {arg=11}{value=153}{display=Channel 153}
	echo value {arg=11}{value=157}{display=Channel 157}
	echo value {arg=11}{value=161}{display=Channel 161}
	echo value {arg=11}{value=165}{display=Channel 165}

    rem # Channel width values
    echo value {arg=12}{value=HT20}{display=20 MHz}
    echo value {arg=12}{value=HT40-}{display=40- MHz}
    echo value {arg=12}{value=HT40+}{display=40+ MHz}
    echo value {arg=12}{value=80MHz}{display=80 MHz}
